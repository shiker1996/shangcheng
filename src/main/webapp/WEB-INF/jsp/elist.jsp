                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered cart_summary">
                                    ...
                                    <c:forEach items="${list }" var="goods">
                                        <tr>
                                            <td><img src="img/${goods.picUrl}" alt="${goods.name }" width="100px"
                                                     height="100px"
                                                     class="img-rounded"></td>
                                            <td>${goods.name }</td>
                                            <td>${goods.num }个</td>
                                            <td class="price"><span>￥${goods.pride }</span></td>
                                            <td>
                                                <div class="btn-group" role="group" aria-label="...">
                                                    <button onclick="location.href='/station?id=${goods.id }&employee=1'"
                                                            type="button" class="btn btn-default">
                                                        <span class="glyphicon glyphicon glyphicon-share-alt"
                                                              aria-hidden="true">详情</span>
                                                    </button>
                                                    <button onclick="location.href='/updateInfo?id=${goods.id }'"
                                                            type="button" class="btn btn-default">
                                                        <span class="glyphicon glyphicon-pencil"
                                                              aria-hidden="true">更新</span>
                                                    </button>
                                                    <button onclick="location.href='/delete?id=${goods.id }'"
                                                            type="button" class="btn btn-default">
