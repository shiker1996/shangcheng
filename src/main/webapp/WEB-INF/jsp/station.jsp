                        ...
                        <div class="order-detail-content">
                            <div class="table-responsive">
                                <table class="table table-bordered  cart_summary">
                                    ...
                                    <tr class="bg-info">
                                        <th>数量</th>
                                        <td style="text-align:center">${good.num }个</td>
                                    </tr>
                                    <tr>
                                        <th>价格</th>
                                        <td class="price"><span>￥${good.pride }</span></td>
                                    </tr>

                                    <tr class="bg-info">
                                        <th>上架日期</th>
                                        <td style="text-align:center"><fmt:formatDate value="${good.onshelf }"
                                                                                      pattern="yyyy年MM月dd日 HH:mm:ss"/></td>
                                    </tr>
                                    <tr class="bg-warning">
                                        <th>生产日期</th>
                                        <td style="text-align:center"><fmt:formatDate value="${good.prodate }"
                                                                                      pattern="yyyy年MM月dd日 HH:mm:ss"/></td>
                                    </tr>
                                    <tr class="bg-danger">
                                        <th>保质期</th>
                                        <td style="text-align:center"><fmt:formatDate value="${good.reldate }"
                                                                                      pattern="yyyy年MM月dd日 HH:mm:ss"/></td>
                                    </tr>
...
<!-- jquery js -->
<script type="text/javascript" src="/js/jquery.min.js"></script><!-- jquery js -->
